...
illegalQM Q {tsEq = (Just _), gt = (Just _)}        = (True, "Can't query 'Timestamp Equal' with any other timestamp condition.")
illegalQM Q {tsEq = (Just _), ge = (Just _)}        = (True, "Can't query 'Timestamp Equal' with any other timestamp condition.")
illegalQM Q {tsEq = (Just _), lt = (Just _)}        = (True, "Can't query 'Timestamp Equal' with any other timestamp condition.")
illegalQM Q {tsEq = (Just _), le = (Just _)}        = (True, "Can't query 'Timestamp Equal' with any other timestamp condition.")
illegalQM _                                         = (False, "")
